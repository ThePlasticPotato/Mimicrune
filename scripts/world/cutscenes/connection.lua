return {
    connection_established = function(cutscene, event)
        ...
        local beamsoul = SoulAppearance(300, 220)
        ...
        Game.world:startCutscene("connection", "connection_terminated")
        cutscene:fadeIn(0.5)
    end,

    connection_terminated = function(cutscene, event)
        local text
        ...
        cutscene:wait(1)
        local beamsoul2 = SoulAppearance(300, 320)
        ...
        cutscene:wait(5)
        local soulglow = SoulGlow(300,320,beamsoul2)
