...
function ObjectivePopup:init(x, y, width, height, text, display_time, sound, goner, auto_close)
    ...
    self.auto_close = auto_close or true
    self:slideTo(0, y, 1, "in-out-cubic", function () Game.stage.timer:after(display_time or 8, function () if(self.auto_close) then self:slideTo(-550, y, 1, "in-out-cubic", function () self:remove() end) end end) end)
